...
<script src="${pageContext.request.contextPath}/js/blockly/blockly_compressed.js"></script>
<script src="${pageContext.request.contextPath}/js/blockly/blocks_compressed.js"></script>
<script src="${pageContext.request.contextPath}/js/blockly/php_compressed.js"></script>

<script src="${pageContext.request.contextPath}/js/blockly/msg/js/es.js"></script>
